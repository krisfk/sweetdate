        ...
        <form action="" class="login-form">
            <table>
                <tr>
                    ...
                    <td colspan="2"><input type="text" placeholder="登記電郵" class="form-control" id="login-email"
                            name="login-email">
                    </td>
                </tr>
                <tr>
                    <!-- <td><label for="login-password">登入密碼：</label> </td> -->
                    <td colspan="2"><input type="text" placeholder="登入密碼" class="form-control" id="login-password"
