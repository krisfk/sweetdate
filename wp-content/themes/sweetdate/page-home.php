...
<div class="container mt-4">
    ...
    <div class="row gx-5">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12  ">
            ...
            <div class="mt-4">
                〝蜜遇〞SweetDate知道港人忙工作，忙生活已成常態，很多職業只偏向單一性別，以致有條件的您認識異性的機會大大減少。 <br><br>
                我們的宗旨就是希望提供為您擴闊社交圈子的平台，令您可以認識來自不同背景的朋友，助您開拓多元化的社交圈子，及提高您遇上Perfect match的機會，以告別單身。<br><br>
                有別於其他Speed dating，〝蜜遇〞設計出一連串嶄新的"蜜遇"過程。每次活動皆經過悉心佈置，例如用上專業香薰治療師調配的法國高級香薰，務求令會員可在一個身心放鬆的環境下，做到自然融入及統一的狀態。
