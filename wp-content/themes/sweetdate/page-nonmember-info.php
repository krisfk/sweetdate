                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select required id="annual-income" name="annual-income" class="form-control">
                                    <option value="">選擇</option>
                                    <option <?php echo get_field('annual_income')=='250,000以下' ? 'selected' :'';?>
                                        value="250,000以下">250,000以下</option>
                                    <option <?php echo get_field('annual_income')=='250,001-500,001' ? 'selected' :'';?>
                                        value="250,001-500,001">250,001-500,001</option>
                                    <option <?php echo get_field('annual_income')=='500,000-750,000' ? 'selected' :'';?>
                                        value="500,000-750,000">500,000-750,000</option>
                                    <option <?php echo get_field('annual_income')=='annual-income' ? 'selected' :'';?>
                                        value="750,001-100,000">750,001-100,000</option>
                                    <option <?php echo get_field('annual_income')=='1,000,001以上' ? 'selected' :'';?>
